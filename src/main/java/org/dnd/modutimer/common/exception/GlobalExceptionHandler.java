...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiUtils.ApiResult<?>> handleMissingParams(MissingServletRequestParameterException ex) {
        Map<String, String> message = new HashMap<>();
        message.put("error", String.format("The required parameter '%s' of type '%s' is missing", ex.getParameterName(),
            ex.getParameterType()));
    ...
    public ResponseEntity<ApiUtils.ApiResult<?>> handleMissingServletRequestPartException(

...
/**
 * HTTP 응답을 처리하기 위한 유틸리티 메서드 보안 관련 예외(예: 인증되지 않음, 접근 금지)가 발생했을 때, 적절한 HTTP 응답을 생성하고 클라이언트에 전송하는 역할 수행 HTTP 상태 코드, 에러 메시지
 * 등을 JSON 형식으로 변환하여 응답 본문에 포함함
 */
public class FilterResponseUtils {
    ...
    private static void sendResponse(HttpServletResponse resp, String responseBody, HttpStatus status)
        throws IOException {
